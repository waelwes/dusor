        ...
        <div className="header-actions" style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <div className="desktop-only" style={{ position: 'relative' }}>
            <button 
              ...
              style={{ background: 'transparent', border: 'none', color: 'var(--text-main)', fontSize: '1rem', fontWeight: '500', cursor: 'pointer', padding: '0', display: 'flex', alignItems: 'center', gap: '0.3rem', fontFamily: 'inherit' }}
            >
          ...
          {/* Get in Touch Button */}
          <Link href="/contact" className="btn btn-outline header-cta" style={{ borderRadius: '50px' }}>
          ...
          >
            <span style={{ display: 'block', width: '22px', height: '2px', background: 'var(--text-main)', borderRadius: '2px', transition: 'all 0.3s', transform: menuOpen ? 'translateY(7px) rotate(45deg)' : 'none' }} />
            <span style={{ display: 'block', width: '22px', height: '2px', background: 'var(--text-main)', borderRadius: '2px', margin: '5px 0', transition: 'all 0.3s', opacity: menuOpen ? 0 : 1 }} />
            <span style={{ display: 'block', width: '22px', height: '2px', background: 'var(--text-main)', borderRadius: '2px', transition: 'all 0.3s', transform: menuOpen ? 'translateY(-7px) rotate(-45deg)' : 'none' }} />
          </button>
        </div>
      </div>
